...
/***/ "./resources/js/dashboard/imgmapper.js":
/*!*********************************************!*\
  !*** ./resources/js/dashboard/imgmapper.js ***!
  \*********************************************/
...
/***/ "./resources/js/dashboard/pannelum-debugger.js":
/*!*****************************************************!*\
  !*** ./resources/js/dashboard/pannelum-debugger.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (/* binding */ _default)
/* harmony export */ });
/* harmony import */ var pannellum__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! pannellum */ "./node_modules/pannellum/build/pannellum.js");
/* harmony import */ var pannellum__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(pannellum__WEBPACK_IMPORTED_MODULE_0__);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var _default = /*#__PURE__*/function (_window$Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      setTimeout(function () {
        var container = _this.data.get('name');

        var panorama = _this.data.get('panorama');
        ...
        var scene = {
          ...
          'compass': false,
          'panorama': _this.data.get('panorama')
        };
        var initialAngle = parseFloat(_this.angleTarget.value);
        ...
        var _iterator = _createForOfIteratorHelper(_this.hotspots),
            _step;
        ...
        var viewerElement = document.getElementById(container);
        viewer.on('animatefinished', function (ev) {
          _this.angleTarget.value = viewer.getYaw();
        });
        viewerElement.addEventListener('contextmenu', function (ev) {
          return _this.openModal(ev, viewer);
        });
      }, 200);
    }
  }, {
    key: "openModal",
    value: function openModal(ev, viewer) {
      var _this2 = this;

      var _viewer$mouseEventToC = viewer.mouseEventToCoords(ev);

      var _viewer$mouseEventToC2 = _slicedToArray(_viewer$mouseEventToC, 2);

      this.pitchTarget.value = _viewer$mouseEventToC2[0];
      this.yawTarget.value = _viewer$mouseEventToC2[1];
      var form = this.modal.firstElementChild.firstElementChild;
      this.application.getControllerForElementAndIdentifier(this.modal, 'modal').open({
        title: this.data.get('title') || this.modal.dataset.modalTitle,
        submit: this.data.get('action'),
      ...
      form.addEventListener('submit', function () {
        var _iterator2 = _createForOfIteratorHelper(_this2.constructor.targets),
            _step2;
...
/*!***********************************!*\
  ...
  \***********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dashboard_pannelum_debugger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dashboard/pannelum-debugger */ "./resources/js/dashboard/pannelum-debugger.js");
/* harmony import */ var _dashboard_imgmapper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboard/imgmapper */ "./resources/js/dashboard/imgmapper.js");


application.register('pnldbg', _dashboard_pannelum_debugger__WEBPACK_IMPORTED_MODULE_0__.default);
application.register('imgmap', _dashboard_imgmapper__WEBPACK_IMPORTED_MODULE_1__.default);
})();
